    ...
    .ready(function () {
        const DATASETS = {
            videogames: {
                ...
                FILE_PATH: "https://cdn.rawgit.com/freeCodeCamp/testable-projects-fcc/a80ce8f9/src/data/tree" +
                        "_map/video-game-sales-data.json"
            },
            movies: {
                TITLE: "Movie Sales",
                DESCRIPTION: "Top 100 Highest Grossing Movies Grouped By Genre",
                FILE_PATH: "https://cdn.rawgit.com/freeCodeCamp/testable-projects-fcc/a80ce8f9/src/data/tree" +
                        "_map/movie-data.json"
            },
            kickstarter: {
                TITLE: "Kickstarter Pledges",
                DESCRIPTION: "Top 100 Most Pledged Kickstarter Campaigns Grouped By Category",
                FILE_PATH: "https://cdn.rawgit.com/freeCodeCamp/testable-projects-fcc/a80ce8f9/src/data/tree" +
                        "_map/kickstarter-funding-data.json"
            }
        }
        ...
        // dataSelector.innerHTML = '<a>' + DATASETS[0].TITLE + '</a>' + '/' + '<a>' +
        // DATASETS[1].TITLE + '</a>' + '/' + '<a>' + DATASETS[2].TITLE + '</a>';
